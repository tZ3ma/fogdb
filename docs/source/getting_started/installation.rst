...
.. code-block:: console
   ...
   $ pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ fogdb

This installs the TestPyPI_ version of :code:`fogdb` while resolving the dependencies on PyPI_.
...
3. Clone the repo to a local directory (uses package name if square bracket
   ...
   .. code-block:: console
      ...
      $ git clone https://github.com/tZ3ma/fogdb [fogdb-develop]
